      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto  ">
          <div className="grid md:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center group">
                  <Mail className="w-5 h-5 text-purple-400 mr-4 group-hover:scale-110 transition-transform" />
                  <a
                ...
                <div className="flex items-center group">
                  <Phone className="w-5 h-5 text-purple-400 mr-4 group-hover:scale-110 transition-transform" />
                  <a
                ...
                <div className="flex items-center group">
                  <MapPin className="w-5 h-5 text-purple-400 mr-4 group-hover:scale-110 transition-transform" />
            ...
            <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-lg border border-purple-500/30 rounded-xl p-8 hover:border-purple-400/50 transition-all duration-300">
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-white placeholder-gray-400 transition-all duration-300"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="4"
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-white placeholder-gray-400 transition-all duration-300 resize-none"
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed text-white px-6 py-3 rounded-lg transition-all duration-300 font-semibold flex items-center justify-center group"
                  >
                    {status === 'sending' ? (
                      <>
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-gray-700 to-gray-600 hover:from-gray-600 hover:to-gray-500 text-white px-6 py-3 rounded-lg transition-all duration-300 font-semibold flex items-center justify-center group"
